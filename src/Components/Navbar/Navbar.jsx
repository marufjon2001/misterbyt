        ...
        <Navbar.Collapse id="navbarScroll">
          <div className="pl-[2.56vw] flex items-center gap-[4.28vw] md:flex-col">
            <div className="flex gap-[2.77vw] items-center md:flex-col">
              <h4 className="flex gap-[10px] text-[#3E3E3E] text-Proxima text-[1.25vw] font-[500] items-center cursor-pointer">
                <MenuIcon className="text-cyan-500 w-[2.77vw] h-[2.77vw]" />{" "}
                Цены на услуги
              </h4>
              <h4 className="text-[#3E3E3E] text-Proxima text-[1.25vw] font-[500] cursor-pointer">
                О компании
              </h4>
              <h4 className="text-[#3E3E3E] text-Proxima text-[1.25vw] font-[500] cursor-pointer">
                Отзывы
            ...
            <div className="flex items-center gap-[1vw] md:flex-col cursor-pointer ">
              <Button/>
              <h1 className="text-[#3E3E3E] text-[1.94vw] font-[700] cursor-pointer">
                8 (495){" "}
